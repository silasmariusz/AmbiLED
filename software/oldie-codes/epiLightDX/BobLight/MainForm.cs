...
*/
        ...
        private void DeinitializeDXDevice()
        {
            s.Dispose();
            device.Dispose();
        }
...
//                g.FillRectangle(Brushes.White, 0, 0, lnNewWidth, lnNewHeight);
        ...
        {
            GlobalVariables.NrDisplays = Manager.Adapters.Count - 1;

            for (int I = 0; I <= GlobalVariables.NrDisplays; I++)
            {
