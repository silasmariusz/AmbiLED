...
namespace epiLight
{
    public partial class MainForm : Form
    {
        ...
        private int swidth, sheight, c = 0;
        ...
        private void MainForm_Load(object sender, EventArgs e)
        {
            ...
            for (int I = 0; I < root.ChildNodes.Count; I++)
            {
                ...
                else if (root.ChildNodes[I].Name == "ResizeIt")
                {
                    if (root.ChildNodes[I].InnerText == "true")
                    {
                        ResizeIt.Checked = true;
                    }
                }
                else if (root.ChildNodes[I].Name == "ResizeValue")
                {
                    ResizeValue.Value = Convert.ToInt32(root.ChildNodes[I].InnerText, 10);
                }
                ...
                else if (root.ChildNodes[I].Name == "enabled")
                {
                    ...
                    else
                    {
                        ...
                        this.Text = "epiLightGDI32 DISABLED";
...
*/
            ...
            if (close)
            {
                ...
                for (int I = 0; I < root.ChildNodes.Count; I++)
                {
                    ...
                    {
                        root.ChildNodes[I].InnerText = ResizeValue.Value.ToString();
                    }
                    else if (root.ChildNodes[I].Name == "color")
                    {
...
//            IntPtr hDC = User32.GetDC(User32.GetDesktopWindow());
            ...
            if (hBitmap != IntPtr.Zero)
            {
                ...
                b = System.Drawing.Image.FromHbitmap(hBitmap);
